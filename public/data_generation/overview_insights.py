...
class OverviewInsights:
    ...
    def generate_overview_insights(self) -> Dict:
        ...
        time_to_employment = self.df[self.df['IndicatorDescription'] == 'Total number of days until the first job']['IndicatorValue'].sum()
        ...
        overview_insights = {
            "summaryCards": {
                ...
                "averageTimeToEmployment": time_to_employment
            },
