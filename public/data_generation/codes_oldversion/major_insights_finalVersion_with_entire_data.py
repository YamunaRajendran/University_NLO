...
class MajorInsights:
    ...
    def get_total_metrics(self, df: pd.DataFrame = None) -> Dict:
        ...
        # Employment gender gap by period
        employment_gender_gap = {
            "beforeGraduation": self.calculate_gender_gap_for_period(df, "Before graduation"),
            "withinFirstYear": self.calculate_gender_gap_for_period(df, "Within a year"),
            "afterFirstYear": self.calculate_gender_gap_for_period(df, "More than a year")
        }
        ...
        return {
            ...
            "genderDistribution": {
                ...
                "genderGap": round(male_percentage - female_percentage, 2)
            },
