...
from major_insights_arabic import MajorInsights
...
def main():
    ...
    df = pd.read_json(r"C:\Users\sanav\work\D2R\NLO\University\public\output\translated_full_data_arabic.json", orient="records", dtype='object')
    ...
    output_file = r"C:\Users\sanav\work\D2R\NLO\University\public\output\major_insights_arabic.json"
